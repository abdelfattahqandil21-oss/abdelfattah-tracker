...
<div class="bg-bg-card p-4 rounded-lg border border-border">
  <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 mb-3">
    ...
    <input 
      ...
      class="col-span-1 lg:col-span-2 p-3 border border-border rounded-lg bg-bg-input text-text-main placeholder-text-muted focus:border-primary focus:outline-none"
      (keyup.enter)="add()">
    ...
    <button
      (click)="add()"
      class="col-span-1 sm:col-span-2 lg:col-span-1 bg-primary text-text-inverse px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors font-medium">
  ...
  <textarea
    ...
    rows="2"
    class="w-full p-3 border border-border rounded-lg bg-bg-input text-text-main placeholder-text-muted focus:border-primary focus:outline-none resize-none">
  </textarea>
</div>
